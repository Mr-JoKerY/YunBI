...
import com.hyw.project.model.vo.BiResponse;
import com.hyw.project.service.ChartService;
import com.hyw.project.service.UserService;
import com.hyw.project.utils.ExcelUtils;
import com.hyw.project.utils.SqlUtils;
...
public class ChartController {
    ...
    public BaseResponse<BiResponse> genChartByAi(@RequestPart("file") MultipartFile multipartFile,
        ...
        // 调用AI
        String result = aiManager.doChat(BiConstant.BI_MODEL_ID, userInput.toString());
        String[] aiData = result.split(BiConstant.AI_SPLIT_STR);
    ...
    public BaseResponse<BiResponse> genChartByAiAsync(@RequestPart("file") MultipartFile multipartFile,
        ...
        CompletableFuture.runAsync(() -> {
            ...
            String result = aiManager.doChat(BiConstant.BI_MODEL_ID, userInput.toString());
            String[] aiData = result.split(BiConstant.AI_SPLIT_STR);
            log.info("aiData len = {} data = {}", aiData.length, result);
            if (aiData.length < 3) {
...
//                "{明确的数据分析结论、越详细越好，不要生成多余的注释}";
    ...
    public BaseResponse<Boolean> reloadChartByAi(long chartId, HttpServletRequest request) {
        ...
        User loginUser = userService.getLoginUser(request);
        return ResultUtils.success(chartService.reloadChartByAi(chartId, loginUser));
    }
